...
class bus_booking:
    ...
    def home_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 30', bg='red', fg='blue',relief=RAISED,padx=10,pady=10,bd=5).grid(row=2,
                                                                                                            column=3,
                                                                                                            columnspan=9,
                                                                                                            padx=w // 2.5)
        ...
        Label(root, text='\n\n\n\n\n\n').grid(row=3, column=4)
        Button(root, text='Seat Booking', font='Arial 14 bold', bg='Light green', fg='black',width=35,height=5,command=home_to_jouney_detail).grid(row=4, column=4)
        Label(root, text='\n\n\n\n\n\n').grid(row=3, column=6)
        Button(root, text='Check Booked Seat', font='Arial 14 bold', bg='green3', fg='black',width=35,height=5,command=home_to_check_booking).grid(row=4, column=6)
        Label(root, text='\n\n\n\n\n\n').grid(row=3, column=8)
        Button(root, text='Add Bus Details', font='Arial 14 bold', bg='green', fg='black',width=35,height=5,command=home_to_db_add_page ).grid(row=4, column=8)
        Label(root, text='\n').grid(row=5, column=8)
        Label(root, text='For Admin Only', fg='red',font='Algerian 16').grid(row=6, column=8)
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: Divyanshu Prajapati", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr. No. : 221B155", font='Arial 16 bold', fg='blue').pack()
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<100:
                                                    if seats>0 and seats<=self.v:
                                                        ...
                                                        errorinfo="you can only book upto "+str(self.v)+" seats"
                                                        showerror("booking limit exceed",errorinfo)
                                                else:
